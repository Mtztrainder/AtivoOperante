...
function OpenModal() {
    ...
    <div role="alert" class=" container mx-auto w-11/12 md:w-2/3 max-w-lg">
        <div class="relative py-8 px-5 md:px-10 bg-white dark:bg-gray-800 shadow-md rounded border border-gray-400">
            ...
            <h1 class="text-gray-800 dark:text-white font-lg font-bold tracking-normal leading-tight mb-4">Cadastrar Tipos de Problema</h1>
            
            <form id="form-tipo">
                <input id="id" name="id" type="hidden" />
                <label for="nome" class="text-gray-800 text-sm 
                                        font-bold leading-tight tracking-normal dark:text-white">Nome do Tipo <span class="text-red-600 italic  text-xs">*</span></label>
