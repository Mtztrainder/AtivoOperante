    ...
    dados.forEach(orgao => {
        ...
        <tr class="flex w-full hover:bg-gray-100 hover:bg-gray-200">
            ...
            <td class="p-4 w-4/12 space-x-2 whitespace-nowrap">
                ...
                <button type="button" data-modal-toggle="delete-user-modal" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-800 focus:ring-4 focus:ring-red-300 focus:ring-red-900" onclick="Deletar(${orgao.id}, '${orgao.nome}')" >
