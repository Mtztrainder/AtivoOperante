...
public class Denuncia {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_AO_DENUNCIA")
    @Column(name="DEN_ID")
    private Long id;
    ...
    public Denuncia(Long id, LocalDateTime dtCriacao, String titulo, String texto, int urgencia, Orgaos orgao,
